    ...
    for (const r of rawResults) {
      ...
      if (typeof sym === 'string' && strategyValid) {
        ...
        if (d.requestedStrategy === 'csp' && r.bestCandidate == null) {
          ...
          const marketStates = new Set(['QUALIFIED','QUALIFIED_WITH_LIQUIDITY_WARNING','DISQUALIFIED_INVALID_QUOTE','DISQUALIFIED_POOR_LIQUIDITY','DISQUALIFIED_IVR','DISQUALIFIED_IVR_UNAVAILABLE','DISQUALIFIED_EARNINGS','DISQUALIFIED_FOUNDATION_INELIGIBLE','DISQUALIFIED_FOUNDATION_INSUFFICIENT_EVIDENCE']);
