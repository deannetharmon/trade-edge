...
mkdir -p "$(dirname "app/trade-log/page.tsx")"
cat > app/trade-log/page.tsx << 'SCRIPT_EOF'
...
mkdir -p "$(dirname "app/debug/trade-log-validation/page.tsx")"
cat > app/debug/trade-log-validation/page.tsx << 'SCRIPT_EOF'
...
git add app/trade-log/page.tsx app/debug/trade-log-validation/page.tsx
git commit -m "feat(trade-log): TRADELOG-0001 Net Edge/POP validation debug page + Trade Log CSV export"
git push

echo "TRADELOG-0001 deployed. Verify via Vercel preview."
