...
function ChartButton({ symbol, th, isOpen, onOpen, onClose }: {
  symbol: string;
...
export default function EnginePage() {
  ...
  const closeChart = () => { console.trace('[ChartDebug] closeChart called'); setOpenChartSymbol(null); };
    ...
    <div className={`min-h-screen ${th.bg} transition-colors duration-200`} style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div className={`${th.header} border-b ${th.border} px-6 pb-0 pt-3 sticky top-0 z-50 flex flex-col`}>
        ...
        <div className="flex items-center gap-0 w-full border-t border-white/10">
          ...
          <a href="/paper-trading" className="text-[10px] font-bold px-3 py-2 text-white/55 hover:text-white/80 transition-colors tracking-wider">PAPER TRADING</a>
