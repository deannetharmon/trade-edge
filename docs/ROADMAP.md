...
- **QUAL-STATES-0001 (approved 2026-09-25):** Qualified / Caution / Disqualified across scans, override kept and recorded through to the trade log. Phases 0, 1 and 2 DONE (Ranked scan can produce qualified rows; three-state badge, borders and header counts on spread cards; order-window acknowledgment, TRADE THIS variants, and the override recorded through the entry snapshot to a Trade Log chip and CSV columns). Next: phase 3 (CSP cards and order window). Ticket: `docs/tickets/QUAL-STATES-0001-three-qualification-states.md`.
