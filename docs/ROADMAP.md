...
- **QUAL-STATES-0001 (approved 2026-09-25):** Qualified / Caution / Disqualified across scans, override kept and recorded through to the trade log. Phase 0 DONE (Ranked scan can now produce qualified rows; earnings buffer and OI-as-warning now apply to it). Next: phase 1 (state function, header counts, card labels on spreads), then phase 2 (order-window acknowledgment), then phase 3 (CSP). Ticket: `docs/tickets/QUAL-STATES-0001-three-qualification-states.md`.
