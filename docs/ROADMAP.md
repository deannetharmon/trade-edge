...
- EARNINGS-PRECHECK-0001 (CC and CSP earnings pre-check becomes advisory and per-expiry; Dean's false earnings warning): Ian approved, ticket saved, Dane building (Next #1). Full suite and Quinn review of the CSP classification path required.
