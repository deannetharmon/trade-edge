...
Last updated: 2026-07-16. Paste this file (or point Claude at its repo path) at the start of a new chat to resume with full context.
...
- Latest commit: `e35c96d` — "refactor(csp): rename realistic loss to 2σ scenario loss"
- Branch is pushed and synchronized with `origin/feature/portfolio-intelligence`.
- Latest remote commit: `e35c96d` — "refactor(csp): rename realistic loss to 2σ scenario loss"
...
5. **`next build` validation is unreliable in this sandbox** — don't repeatedly retry it; note the limitation and move on, consistent with how PI-0006A and this CSP ticket both handled it.
...
- `app/portfolio/page.tsx` — main portfolio dashboard page, wires most of the above together (large file).
