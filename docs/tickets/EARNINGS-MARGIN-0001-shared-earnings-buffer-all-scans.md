...
**Update (2026-09-25):** fixed in QUAL-STATES-0001 phase 0. The Ranked scan now uses the shared 10-day buffer, as a fail (Ian's independent ruling), so Ranked spreads have it.
