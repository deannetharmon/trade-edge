# Launch-Gate Record — `leaps_deep_analysis` — v1

**Status:** DRAFT
**Route:** `leaps_deep_analysis`
**Owner:** <n> (process owner: Paul) · **Approver:** <n> (Dean) · **Approved on:** <date> · **Expires / re-review by:** <date>
**Registry entry:** `lib/ai-policy/launchGates.ts` id `leaps_deep_analysis-v1` (approval = reviewed commit adding this entry; **not added**)
...
**Prompt template + lexicon + registry versions under test:** Not yet built: prompt template, registry and fixtures arrive with AI-POLICY-0001D (needs Ian's field list and D14)
