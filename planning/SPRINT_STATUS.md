...
**Last Updated:** 2026-07-25 (WA-0003 closeout. `main` and `origin/main` are both at `abbf261` ("fix(mission-control): use absolute priority links"), working tree clean on `main`. **No implementation sprint is currently active.**)
**Primary Branch:** `main`
...
**Every sprint through WA-0003 listed above is accepted, complete, and merged into `main`.** No implementation sprint is currently active. **OE-0003 (Optional Opportunity Context)** is queued as planned future work (see Known Follow-Ups and `docs/roadmap/ROADMAP.md`); not approved, scoped, or started. The MB-0001B follow-up pass (page narrative refactor and UI concepts) is not approved, scoped, or started. **WA-0004 through WA-0006** (the remainder of WA-0001's proposed workspace-cleanup sequence, including the still-binding WA-0004 obligation to retire WA-0002's transitional Briefing content) are not approved, scoped, or started. PI-0015 / Portfolio Intelligence corrections remain queued for live-market acceptance validation. `epic/autopilot` remains untouched by every sprint in this document.
...
**Every sprint through WA-0003 is accepted, complete, and merged.** No implementation sprint is currently active. No implementation sprint is currently selected as "next" — that determination belongs to the Product Owner, guided by the candidates below (not ranked; ranking is a Product Owner decision):

1. **WA-0004 through WA-0006** — the remainder of WA-0001's proposed workspace-cleanup sequence. **WA-0004 in particular carries a binding obligation from WA-0002** (retire the transitional Daily Briefing content on Positions — see Known Follow-Ups above) and should not be scoped without accounting for it.
...
3. **OE-0003 — Optional Opportunity Context** — wire real capital/exposure data into the Opportunity Engine, contingent on a PortfolioMode decision for `/screener`.
