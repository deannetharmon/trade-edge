...
export function PositionsWorkspaceBase({ model, th, getManagementActions, onExecute, renderStopControl, onAnalyze }: { model: PositionsWorkspaceModel; th: typeof THEMES[Theme] } & ManagementActionProps) {
