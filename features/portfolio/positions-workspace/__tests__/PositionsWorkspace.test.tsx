...
describe('PositionsWorkspace', () => {
  ...
  it('shows compact intentional headers, canonical breakeven, Notes before Suggested Action, and compact actions', async () => {
    ...
    // The chart link is the last line of the Position cell, below the contract count, and no longer in Price Change.
    ...
    const strikeGapCell = screen.getByRole('columnheader', { name: 'Price Change' }).closest('table')?.querySelectorAll('tbody tr')[0]?.querySelectorAll('td')[headerTexts.indexOf('Price Change')];
